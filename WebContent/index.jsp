	...
	<body>
		...
		<div id="login">
			<div id="login_bg">
				...
				<input type="email" id="login_name" placeholder="Email"/>
				<input type="password"  id="login_password" placeholder="Password"/>
				<div id="login_yzm">
					<input type="text"  id="login_yzm_input" value="验证码" /><img src="img/logo.png" width="100px" height="46px"/>
				</div>
		...
		<div id="body">
			<div id="body_left">
				<div class="card">
					...
					<div class="card_foot">
						<div class="card_foot_add">
							<img src="img/add.png" width="26px"/><span>10</span>
						</div>
						<div class="card_foot_agree" >
							<img src="img/agree.png" width="26px"/><span>0</span>
						</div>
						<div class="card_foot_disagree" >
							<img src="img/disagree.png" width="26px"/><span>0</span>
						</div>
						<div class="card_foot_question">
							<img src="img/yiwen.png" width="26px"/><span>0</span>
						</div>
						<div class="card_foot_get">
							<img src="img/shouchang.png" height="26px"/><span>0</span>
						</div>
						<div class="card_foot_love">
							<img src="img/love.png" width="26px"/><span>0</span>
						</div>
					</div>
				</div>
				<div class="card">
